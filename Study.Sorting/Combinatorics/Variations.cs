...
namespace Study.Algo
{
    ...
    public class Variations<T> : IMetaCollection<T>
    {
        ...
        public Variations(List<T> values, int lowerIndex)
        {
        ...
        public Variations(List<T> values, int lowerIndex, GenerateOption type)
        {
        ...
        /// </summary>
        public class EnumeratorWithRepetition : IEnumerator<List<T>>
        {
        ...
        /// </summary>
        public class EnumeratorWithoutRepetition : IEnumerator<List<T>>
        {
            ...
            private void ComputeCurrent()
            {
                if (myCurrentList == null)
                {
                    myCurrentList = new List<T>();
                    int index = 0;
                    List<int> currentPermutation = (List<int>)myPermutationsEnumerator.Current;
                    for (int i = 0; i < myParent.LowerIndex; ++i)
                    {
        ...
        private void Initialize(List<T> values, int lowerIndex, GenerateOption type)
        {
